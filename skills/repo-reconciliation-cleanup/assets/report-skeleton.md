...
**事实面状态**
- authority tip: …   ← write authority tip (GitHub `origin`)
- projection: … | not-applicable
- deploy/manifest tip: … | same-as-authority | UNKNOWN  ← **not** write SoT
- AGENTS.md remote contract: clean | **MUST-FIX inverted SoT**
- local/worktrees: …
- open PRs: …
- backlog Issues: …
- residue: …
